...
class GenerateBladeFiles extends Command
{
     ...
     * @var string
     */
    protected $signature = 'generate:blades';
     ...
     * @var string
     */
    protected $description = 'Generate or update Blade files for each product in the database';
...
EOT;
        ...
        $this->info("Blade file generation and updates completed successfully!");
    }
}

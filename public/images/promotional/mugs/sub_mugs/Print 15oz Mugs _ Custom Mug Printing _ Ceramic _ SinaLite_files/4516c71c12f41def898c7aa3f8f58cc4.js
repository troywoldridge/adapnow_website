...
var config = {
	map: {
        '*': {
        	lofStoreCredit:       'Lof_StoreCredit/js/credit',
        	lofCartCredit: 'Lof_StoreCredit/js/checkout/cart-credit'
        }
    }
};
...
var config = {
	paths: {
        'md5': 'Sinalite_Catalog/js/md5',
        'turnaround': 'Sinalite_Catalog/js/turnaround',
        'mixpanel': 'Sinalite_Catalog/js/mixpanel',
        'quickship': 'Sinalite_Catalog/js/quickship'
    }
};
require.config(config);
})();
...
var config = {
    map: {
        '*': {
            myOrdersSearchForm: 'Sinalite_Sales/js/myOrdersSearchForm'
        }
    }
};
...
var config = {
    paths: {
        jqueryForm: 'Sinalite_FileUploader/js/jquery.form',
        fileUploader: 'Sinalite_FileUploader/js/jquery.uploadfile-4.0.11'
    }
};
require.config(config);
})();
...
var config = 
{
    map: 
    {
        '*': 
        {
            'PayPal_Braintree/js/view/payment/method-renderer/paypal':'Sinalite_Paypal/js/view/payment/method-renderer/paypal'
        }
    }
};
require.config(config);
...
var config = 
{
    map: 
    {
        '*': 
        {
            'Magento_OfflinePayments/js/view/payment/method-renderer/purchaseorder-method':'Sinalite_PoOrder/js/view/payment/method-renderer/purchaseorder-method'
        }
    }
};
require.config(config);
...
var config = {
    paths: {
        socialProvider: 'Mageplaza_SocialLogin/js/provider',
        socialPopupForm: 'Sinalite_SocialLogin/js/popup'
    }
};
...
var config = {
    map: {
        '*': {
            categoryProducts: 'Sinalite_Megamenu/js/topmenuCategoryProducts'
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
            arrowButton: 'Magento_Customer/js/arrowButton',
            pobox: 'Magento_Customer/js/pobox'
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
            'Uppy' : 'Magento_Catalog/js/Uppy',
            'Lozad' : 'Magento_Catalog/js/lozad.min',
            'Intro' : 'Magento_Catalog/js/intro.min'
        }
    },
    deps: [
...
var config = {
    ...
    map: {
        '*': {
            cartItemThumbnail: 'Magento_Checkout/js/cartItemThumbnail',
            //'Magento_Checkout/js/view/shipping-address/list': 'Magento_Checkout/js/view/shipping-address/list-dropdown',
            'Magento_Checkout/js/view/minicart': 'Magento_Checkout/js/view/minicart-override',
            'Magento_Checkout/js/model/checkout-data-resolver': 'Magento_Checkout/js/model/checkout-data-resolver-override'
        }
    }
};
require.config(config);
...
var config = {
    ...
    map: {
        '*': {
            'Magento_Ui/js/view/messages': 'Magento_Ui/js/view/messages-override'
        }
    }
};
require.config(config);
...
var config = {
    ...
    map: {
        '*': {
            'Lof_StoreCredit/js/view/payment/credit': 'Lof_StoreCredit/js/view/payment/credit-override',
            'Lof_StoreCredit/js/action/set-credit': 'Lof_StoreCredit/js/action/set-credit-override'
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
            imageLoader: 'js/imageLoader',
            mathHelper: 'js/mathHelper'
        }
    }
};
require.config(config);

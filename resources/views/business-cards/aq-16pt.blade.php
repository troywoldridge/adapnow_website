...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/14pt_matte/bc-aq.png') }}" class="img-fluid mb-4" alt="14pt AQ Semi-Gloss Business Cards" style="max-width: 100%; height: auto;">
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <ul>
                ...
                <li><strong>Coating:</strong> AQ Coating (Not recommended for writing or stamping)</li>
                ...
                <li><strong>Sizes:</strong> 3.5” x 2”, 3.5" x 1.75", 3.5" x 1.5"(firm size)</li>

...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/Die_cut/Die-Cut-Cards.png') }}" class="img-fluid mb-4" alt="Pearl Paper business cards" style="max-width: 100%; height: auto;">
    
    <h2>Die Cut Business Cards</h2>
    <h3>14pt or 16pt + Matte Finish or UV</h3>
    <p>Give your clients the best die cut business cards with our rounded corner, oval, or leaf shaped cards. The smooth, round edges will elevate them as premium business cards that help grow your client’s business... and yours.</p>
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
            <img src="{{ asset('images/business_cards/Diecut_bc/Die-Cut-Cardsv3.png') }}" class="img-fluid mb-4" alt="Die cut buisness cards" style="max-width: 100%; height: auto;">

                <li><strong>Unique Shaped Business Cards</strong></li>
                    <p>Order unique shaped business cards now to elevate your client’s name or brand to the next level! They will stand out from regular business cards so that your clients always get noticed.

                    For our leaf-shaped business cards, the front of the cards will have rounded corners on the top right and bottom left</p>

            <img src="{{ asset('images/Diecut_bc/Die-cut-Cardsv4.png') }}" class="img-fluid mb-4" alt="Die cut cards labeled rounded, leaf and oval" style="max-width: 100%; height: auto;">
            
                <li><strong>Die Cut Business Card Shapes</strong></li>
                    <p>We currently offer the following die cut business card wholesale printing:
                        Rounded corner business cards
                        Leaf die cut business cards
                        Oval business cards</p>

            <img src="{{ asset('images/business_cards/Diecut_bc/Die-Cut-Cards-v2.png') }}" class="img-fluid mb-4" alt="Corner of spot uv card showing  the customer name in the spot UVbusiness card" style="max-width: 100%; height: auto;">

                <li><strong>Stock & Coating Options</li>
                    <p>Choose between 14pt or 16pt stock for your business cards. Then decide whether you will go with our popular matte finish or our high gloss UV coating. Our high quality die cut business cards look great either way!</p>

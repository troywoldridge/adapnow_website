...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/durable_bc/durable_bc.jpg') }}" class="img-fluid mb-4" alt="Durable business cards" style="max-width: 100%; height: auto;">
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
                <li><strong>16pt Tear / Waterproof Stock</strong></li>
                    <p>Completely waterproof, tear resistant, 100% tree free, and recyclable; these business cards are extremely durable and perfect for short run designs.</p>
            <img src="{{ asset('images/business_cards/durable_bc/durable-magnified.png') }}" class="img-fluid mb-4" alt="Hands trying to tear card" style="max-width: 100%; height: auto;">
                <li><strong>100% Waterproof</strong></li>
            <img src="{{ asset('images/business_cards/durable_bc/waterproof.png') }}" class="img-fluid mb-4" alt="Waterproof business card in water" style="max-width: 100%; height: auto;">
                    <p>These cards can stand the worst weather conditions without having their ink run off.</p>
            <li><strong>Tear-Resistant</li>
                <img src="{{ asset('images/business_cards/durable_bc/tear-proof.png') }}" class="img-fluid mb-4" alt="Magnified view of Kraft paper business card" style="max-width: 100%; height: auto;">
                    <p>These cards will stand the test of time without becoming ripped apart - making them perfect for membership or loyalty cards.</p>
            <img src="{{ asset('images/business_cards/Kraft_paper/recyclable.png') }}" class="img-fluid mb-4" alt="Recycle symbol" style="max-width: 100%; height: auto;">
                    <p>Our specialty cards are made from material that is eco-friendly and can safely be recycled.</p>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="stock" class="form-select">
                            <option>18pt Kraft Printed (4/0)</option>
                            <option>18pt Kraft Printed 2 sided (4/4)</option>
                        </select>
                    </div>

...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/18pt_Gloss_lam/gloss-laminated-business-cards.png') }}" class="img-fluid mb-4" alt="14pt Matte Business Cards" style="max-width: 100%; height: auto;">
    
    <h2>18pt Silk Lamination</h2>
    <h3>Business Cards</h3>
    <p>Business cards are widely used as a networking tool and a way to make a good first impression. These business cards have a silky lamination which also offers better durability.</p>
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
                <li><strong>Paper Type:</strong>95 Bright 16pt C2S Stock (18pt with double sided lamination)</li>
                <li><strong>Coating:</strong> High Gloss UV Coating</li>
                <li><strong>Color:</strong> Full color CMYK: 1 sided (4/0), or 2 sided (4/4)</li>
                <li><strong>Quantities:</strong> Ranges from 25 to 25,000</li>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="coating" class="form-select">
                            ...
                            <option>Matte Lamination PG 1 Only</option>
                        </select>
                    </div>

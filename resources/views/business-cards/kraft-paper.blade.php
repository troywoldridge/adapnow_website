...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/Kraft_paper/Kraft-one.jpg') }}" class="img-fluid mb-4" alt="Raised Foil business cards" style="max-width: 100%; height: auto;">
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
                <li><strong>Paper Type:</strong>18pt Kraft Board</li>
                    <p>Simple yet striking, Kraft Paper business cards are unique in appearance and feel. With their cool vintage look, they are a high quality paper stock that is environmentally friendly.</p>
                <li><strong>Features:</strong>Light Weight</li>
         <img src="{{ asset('images/business_cards/Kraft_paper/properties-image-two.png') }}" class="img-fluid mb-4" alt="Kraft paper business card" style="max-width: 100%; height: auto;">
                    <p>Slim and stylish, these cards will easily slip into any pocket, purse or bag.</p>
            <li><strong>100% Recycled Paper</li>
                <img src="{{ asset('images/business_cards/Kraft_paper/kraft-magnified.png') }}" class="img-fluid mb-4" alt="Magnified view of Kraft paper business card" style="max-width: 100%; height: auto;">
                    <p>Our Craft Paper from recycled card stock enables you to be environmentally conscious without having to worry about compromising quality or budget.</p>

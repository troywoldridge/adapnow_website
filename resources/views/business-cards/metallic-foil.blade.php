...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/Metalic foil/foil2.png') }}" class="img-fluid mb-4" alt="Raised Foil business cards" style="max-width: 100%; height: auto;">
    
    <h2>Lamination + Gold / Silver Foil (C1S)</h2>
    <h3>Business Cards</h3>
    <p>Raised foil business cards stand out with their silver or gold custom foil printing. Our wholesale foil printing produces a premium look popular for high-end business.</p>
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
                <li><strong>Paper Type:</strong>16pt + 2 Laminated Stock</li>
                <li><strong>Features:</strong>Premium Feel</li>
         <img src="{{ asset('images/business_cards/Metalic foil/foil-magnified.jpg') }}" class="img-fluid mb-4" alt="Raised Foil business cards" style="max-width: 100%; height: auto;">
                    <p>Our metallic foil cards hold a reassuring, physical quality that lets your customers know they are in the right hands.</p>
            <li><strong>Raised Foil</li>
                <img src="{{ asset('images/business_cards/Metalic foil/raised.png') }}" class="img-fluid mb-4" alt="Raised Foil business cards" style="max-width: 100%; height: auto;">
                    <p>Raised foil adds an additional layer of texture to your card. It allows for a designated area to be given more prominence, ensuring your card receives a great deal of interest and professionalism.</p>
               <li><strong>Reflective Foil</li>
         <img src="{{ asset('images/business_cards/Metalic foil/shine.png') }}" class="img-fluid mb-4" alt="Raised Foil business cards" style="max-width: 100%; height: auto;">
                    <p>This specialty technique produces your artwork in your choice of gold or silver foil color, stamped onto the card for stunning results.</p>
                <li><strong>Quantities:</strong> Ranges from 100 to 5,000</li>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="stock" class="form-select">
                            ...
                            <option>16pt C1S Printed 2 sided (4/4)</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="turnaround" class="form-select">
                            <option>3-4 Business Days</option>
                        </select>
                    </div>

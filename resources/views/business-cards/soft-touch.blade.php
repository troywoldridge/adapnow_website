...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/soft_touch_bc/softTouch-business-cards.png') }}" class="img-fluid mb-4" alt="Soft touch Business Cards" style="max-width: 100%; height: auto;">
    
    <h2>Soft Touch (Suede)</h2>
    <h3>Business Cards</h3>
    <p>Soft touch business cards are sometimes called suede business cards for their luxurious feel.

        Soft, matte, velvet-like surface
        19pt thickness (16pt stock + 3pt lamination)
        Lamination adds protection against scratches and smudges</p>
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
            <img src="{{ asset('images/business_cards/soft_touch_bc/velvet-feel-card.png') }}" class="img-fluid mb-4" alt="Soft Touch buisness cards" style="max-width: 100%; height: auto;">

                <li><strong>19pt Business Cards</strong></li>
                    <p>The soft touch laminate adds a layer to these business cards, enhancing their thickness to help them stand out from the rest in addition to their soft touch finish.</p>

            <img src="{{ asset('images/business_cards/Spot_UV_bc/spot-uv-bc-one.png') }}" class="img-fluid mb-4" alt="Die cut cards labeled rounded, leaf and oval" style="max-width: 100%; height: auto;">
            
                <li><strong>Protective Finish</strong></li>
                    <p>The soft touch lamination film has protective qualities that keep your custom business cards scratch-free and smudge-proof.</p>
             <img src="{{ asset('images/business_cards/soft_touch_bc/premium-feel.jpg') }}" class="img-fluid mb-4" alt="Die cut cards labeled rounded, leaf and oval" style="max-width: 100%; height: auto;">

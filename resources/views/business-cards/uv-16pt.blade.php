...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/14pt_matte/bc-aq.png') }}" class="img-fluid mb-4" alt="14pt Matte Business Cards" style="max-width: 100%; height: auto;">
    
    <h2>UV (High Gloss)</h2>
    <h3>Buisness Cards</h3>
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
                <li><strong>Paper Type:</strong> 14PT + UV (95 Bright C2S)</li>

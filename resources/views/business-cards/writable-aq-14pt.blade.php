...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/14pt_matte/bc-aq.png') }}" class="img-fluid mb-4" alt="14pt Writable + AQ business cards" style="max-width: 100%; height: auto;">
    
    <h2>14pt Writable + AQ (C1S)</h2>
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <ul>
                ...
                <li><strong>Coating:</strong> AQ Coating (1 Side Only</li>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="coating" class="form-select">
                            <option>Gloss AQ PG 1 Only</option>
                        </select>
                    </div>

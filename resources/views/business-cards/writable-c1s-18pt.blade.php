...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/18pt_Gloss_lam/gloss-laminated-business-cards.png') }}" class="img-fluid mb-4" alt="18pt Writable business cards" style="max-width: 100%; height: auto;">
    
    <h2>18pt Writable (C1S)</h2>
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
                <li><strong>Paper Type:</strong>90 Bright 18pt C1S Stock</li>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="stock" class="form-select">
                            <option>18pt C1S Printed 1 side (4/0)</option>
                            <option>18pt C1S Printed 2 sided (4/4)</option>
                        </select>
                    </div>

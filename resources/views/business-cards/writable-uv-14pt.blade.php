...
<div class="container">
    ...
    <div class="col-md-8">
         <img src="{{ asset('images/business_cards/14pt_UV_HG/quick-ship-bc.png') }}" class="img-fluid mb-4" alt="14pt Writable + UV business cards" style="max-width: 100%; height: auto;">
    
    <h2>14pt Writable + UV (C1S)</h2>
    ...
    <div class="tab-content mt-3" id="myTabContent">
        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
            ...
            <h2>Details</h2>
            <ul>
                <li><strong>Paper Type:</strong>90 Bright 14pt C1S Stock</li>
                <li><strong>Coating:</strong> High Gloss UV Coating (1 Side Only</li>
                ...
                <li><strong>Finishing:</strong> Cut to size and box. Rounded corners are optional(1/4" radius)</li>
                <li><strong>File Type:</strong> Print Ready PDF file</li>
                <li><strong>Special Instructions:</strong>Page  of PDF will be printed on coated side. Page 2 will be printed on the uncoated side</li>
            </ul>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="stock" class="form-select">
                            <option>14pt C1S Printed 1 side (4/0)</option>
                            <option>14pt C1S Printed 2 sided (4/4)</option>
                        </select>
                    </div>

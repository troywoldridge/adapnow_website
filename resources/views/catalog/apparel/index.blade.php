        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Complete your outfit with our range of accessories.</p>
                    <a href="{{ route('category.show', ['category' => 'accessories']) }}" class="btn btn-primary">View Accessories</a>
                </div>
            </div>
        </div>

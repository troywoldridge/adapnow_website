...
<div class="container my-5">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="categoryDropdown">
                    ...
                    <!-- Add more product-specific links as needed -->
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle btn-block" type="button" id="flyerDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Flyers
                </button>

...
<div class="container my-5">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="/images/print-products/4mm-foam-2.png" alt="4mm Foam Board" class="img-fluid">
        </div>
        <div class="col-md-6">
            <h2>Description</h2>
            <p>4mm Foam Board</p>
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <h2>Pricing</h2>
            <p>Price: 0.00</p>
            <a href="{{ route('product.show', ['category' => 'print-products', 'productSlug' => '4mm-foam-2']) }}" class="btn btn-primary">Order Now</a>
        </div>
    </div>

...
<div class="container my-5">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="/images/print-products/presentation-folders-14pt-matte-finish-2.png" alt="Presentation Folders 14PT + Matte Finish" class="img-fluid">
        </div>
        <div class="col-md-6">
            <h2>Description</h2>
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <h2>Pricing</h2>
            <p>Price: 0.00</p>
            <a href="{{ route('product.show', ['category' => 'print-products', 'productSlug' => 'presentation-folders-14pt-matte-finish-2']) }}" class="btn btn-primary">Order Now</a>
        </div>
    </div>

...
<div class="container my-5">
    <h1 class="text-center mb-4">3mm Sintra</h1>
    
    <!-- Description Section -->
    <div class="row">
        <div class="col-md-6">
            <img src="/images/print-products/sintra-3mm-2.png" alt="3mm Sintra" class="img-fluid">
        </div>
        <div class="col-md-6">
            <h2>Description</h2>
            <p>3mm Sintra</p>
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <h2>Pricing</h2>
            <p>Price: 0.00</p>
            <a href="{{ route('product.show', ['category' => 'print-products', 'productSlug' => 'sintra-3mm-2']) }}" class="btn btn-primary">Order Now</a>
        </div>
    </div>

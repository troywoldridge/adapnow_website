...
<div class="container my-5">
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="/images/print-products/styrene-20pt-4.png" alt="20pt Styrene" class="img-fluid">
        </div>
        <div class="col-md-6">
            <h2>Description</h2>
            <p>20pt Styrene</p>
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <h2>Pricing</h2>
            <p>Price: 0.00</p>
            <a href="{{ route('product.show', ['category' => 'print-products', 'productSlug' => 'styrene-20pt-4']) }}" class="btn btn-primary">Order Now</a>
        </div>
    </div>

...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <h2>Pricing</h2>
            <a href="{{ route('showProduct', ['category' => 'large-format', 'productSlug' => 'xframe-13oz-matte']) }}" class="btn btn-primary">Order Now</a>
        </div>
    </div>
...
<!-- URL for this product: http://127.0.0.1:8000/product/large-format/xframe-13oz-matte -->

...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <h2>Pricing</h2>
            <a href="{{ route('showProduct', ['category' => 'print-products', 'productSlug' => 'styrene-20pt-2']) }}" class="btn btn-primary">Order Now</a>
        </div>
    </div>
...
<!-- URL for this product: http://127.0.0.1:8000/product/print-products/styrene-20pt-2 -->
